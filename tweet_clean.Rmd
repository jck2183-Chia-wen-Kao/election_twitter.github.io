...
```{r proceessing,  echo=FALSE, message=FALSE, warning=FALSE}
...
```
<<<<<<< HEAD
Distribution of tweets for Trump and Biden over time
=======

### Distribution of tweets for Trump and Beiden over time
>>>>>>> 8c3dbd7d6b83006b4a82f74d1705085cb5b14d96
...
### Plot US states with the most popular tweets by the candidate
