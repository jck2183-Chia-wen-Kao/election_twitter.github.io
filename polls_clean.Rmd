...
This bar graph is to provide additional information for voting breakdown of the candidates between The expected number  of votes for each candidate in the 2020 Presidential Race was expected to be marginly thin. The bar graph below show the voting breakdown by state. 
       ...
       aes(x = long, y = lat,
           group = group, fill = Candidate,
            text = paste("State: ", State, 
                 ...
                 "</br>Votes: ", round(candidate_votes, ),
